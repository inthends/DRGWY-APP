...
import {Flex, Button, WhiteSpace, WingBlank, Icon} from '@ant-design/react-native';
                            ...
                            <WingBlank>
                                <WingBlank>
                                    <Flex style={styles.record}>
                                        <Text
                                            style={item.flag === '出' ? styles.redText : styles.blackText}>{item.flag}</Text>
                                        <WingBlank>
                                            <Text
                                                style={item.flag === '出' ? styles.redText : styles.blackText}>{item.createDate}</Text>
                                        </WingBlank>
                                    </Flex>
                                </WingBlank>
                            </WingBlank>
