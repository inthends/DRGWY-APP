...
export default {
    ...
    gdzcAssetsUseInfo(pageIndex,assetsId) {
        return api.postData('/api/MobileMethod/MGetAssetsUsePageListJson', { pageIndex, pageSize: 10,assetsId });
    },
    //获取附件
    ...
    gdzcRepairList(pageIndex,assetsId) {
        return api.postData('/api/MobileMethod/MGetAssetsRepairPageListJson', { pageIndex, pageSize: 10,assetsId });
    },
    //盘点记录
    gdzcAssetsCheckList(pageIndex,assetsId) {
        return api.postData('/api/MobileMethod/MGetAssetsCheckPageListJson', { pageIndex, pageSize: 10,assetsId });
    },
    //资产盘点
